...
public abstract class AbstractDatagramThottlingTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractDatagramThottlingTest.class);
