...
public class AbstractTcpIperfTest extends AbstractLinuxTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractTcpIperfTest.class);
    ...
    protected static final String IPERF4_CLIENT_DIRECT =
        "iperf3 --client 127.0.0.1 --port 50100 --time 10 --format m --get-server-output --version4";

    protected static final String IPERF4_CLIENT_PROXIED =
        "iperf3 --client 127.0.0.1 --port 50101 --time 10 --format m --get-server-output --version4";
